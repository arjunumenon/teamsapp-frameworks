  ...
  properties: {
    ...
    siteConfig: {
      ...
      appSettings: [
        ...
        {
          name: 'QNA_ENDPOINT'
          value: '' //End Point of Azure Language Studio QnA Maker
        }
        {
          name: 'QNA_PROJECT_NAME'
          value: '' // Name of Azure Language Studio QnA Maker Database
        }
        {
          name: 'QNA_SUBSCRIPTION_KEY'
          value: '' // Subscription Key of Azure Language Studio QnA Maker
        }
      ]
      ftpsState: 'FtpsOnly'
    }
